...
// 1.2 01/02/2016 ajpowell     Changed serial baud rate to 74880 (to match boot data from esp8266)
//
...
//    Use of Particle.delay rather than delay
...
void loop(void) {
  ...
  Particle.delay(1000);     // maybe 750ms is enough, maybe not
